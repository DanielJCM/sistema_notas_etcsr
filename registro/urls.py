...
urlpatterns = patterns('',
    ...
    url(r'^consultar_bien$', views.Consultar_bien.as_view(), name='consultar_bien'),
    url(r'^registrar_bien$', views.Registrar_bien.as_view(), name='registrar_bien'),
    url(r'^editar_bien/(?P<pk>\d+)$', views.Editar_bien.as_view(), name='editar_bien'),
    url(r'^borrar_bien/(?P<pk>\d+)$', views.Borrar_bien.as_view(), name='borrar_bien'),
)
